...
달력을 그릴 때 무작정 benchmarkDay를 기준으로 하는 것이 아니다.

현재 날짜로부터 하루씩 전날로 가면서 firstDay를 찾고,

firstDay에 도달했을 경우 weekArrangeType에 따라 +0 또는 +3을 해서 얻은

'benchmarkDate'를 기준으로 달력을 그린다...
